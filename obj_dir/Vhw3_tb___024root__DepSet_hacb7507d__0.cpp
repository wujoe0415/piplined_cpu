...
VL_INLINE_OPT void Vhw3_tb___024root___sequent__TOP__1(Vhw3_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->correctness = vlSymsp->TOP__hw3_tb.correctness;
}

void Vhw3_tb_core_top___sequent__TOP__hw3_tb__core_top_inst__2(Vhw3_tb_core_top* vlSelf);
void Vhw3_tb_dmem___sequent__TOP__hw3_tb__core_top_inst__dmem_inst__2(Vhw3_tb_dmem* vlSelf);
void Vhw3_tb_core_top___sequent__TOP__hw3_tb__core_top_inst__3(Vhw3_tb_core_top* vlSelf);
...
void Vhw3_tb___024root___eval(Vhw3_tb___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk)))) {
        ...
        Vhw3_tb_dmem___sequent__TOP__hw3_tb__core_top_inst__dmem_inst__2((&vlSymsp->TOP__hw3_tb__core_top_inst__dmem_inst));
        Vhw3_tb_core_top___sequent__TOP__hw3_tb__core_top_inst__3((&vlSymsp->TOP__hw3_tb__core_top_inst));
