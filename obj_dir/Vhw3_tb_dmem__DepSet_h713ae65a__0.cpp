...
VL_INLINE_OPT void Vhw3_tb_dmem___sequent__TOP__hw3_tb__core_top_inst__dmem_inst__1(Vhw3_tb_dmem* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vhw3_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vhw3_tb_dmem___sequent__TOP__hw3_tb__core_top_inst__dmem_inst__1\n"); );
    // Init
    ...
    if (vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__mem_we_dmem) {
