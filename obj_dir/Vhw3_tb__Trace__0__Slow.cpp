...
VL_ATTR_COLD void Vhw3_tb___024root__trace_init_sub__TOP__0(Vhw3_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+111,"correctness", false,-1);
}
...
VL_ATTR_COLD void Vhw3_tb___024root__trace_init_sub__TOP__hw3_tb__0(Vhw3_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+196,"i", false,-1, 31,0);
    tracep->declBus(c+197,"tmp", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+112+i*1,"golden_reg", true,(i+0), 31,0);
    }
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+144+i*1,"golden_dmem", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vhw3_tb___024root__trace_init_sub__TOP__hw3_tb__core_top_inst__0(Vhw3_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+26,"zero", false,-1);
    tracep->declBit(c+27,"overflow", false,-1);
    tracep->declBus(c+203,"OP_AND", false,-1, 3,0);
    tracep->declBus(c+204,"OP_OR", false,-1, 3,0);
    tracep->declBus(c+205,"OP_ADD", false,-1, 3,0);
    tracep->declBus(c+206,"OP_SUB", false,-1, 3,0);
    tracep->declBus(c+207,"OP_NOR", false,-1, 3,0);
    tracep->declBus(c+208,"OP_SLT", false,-1, 3,0);
    tracep->declBus(c+209,"OP_SLL", false,-1, 3,0);
    tracep->declBus(c+210,"OP_SRL", false,-1, 3,0);
    tracep->declBus(c+211,"OP_SRA", false,-1, 3,0);
    tracep->declBus(c+212,"OP_LUI", false,-1, 3,0);
    ...
    tracep->declBus(c+213,"OP_R_TYPE", false,-1, 5,0);
    tracep->declBus(c+214,"OP_ADDI", false,-1, 5,0);
    tracep->declBus(c+215,"OP_SLTI", false,-1, 5,0);
    tracep->declBus(c+216,"OP_LW", false,-1, 5,0);
    tracep->declBus(c+217,"OP_SW", false,-1, 5,0);
    tracep->declBus(c+218,"OP_BEQ", false,-1, 5,0);
    tracep->declBus(c+219,"OP_JAL", false,-1, 5,0);
    tracep->declBus(c+220,"OP_J", false,-1, 5,0);
    tracep->declBus(c+221,"FUNCT_ADD", false,-1, 5,0);
    tracep->declBus(c+222,"FUNCT_SUB", false,-1, 5,0);
    tracep->declBus(c+223,"FUNCT_AND", false,-1, 5,0);
    tracep->declBus(c+224,"FUNCT_OR", false,-1, 5,0);
    tracep->declBus(c+225,"FUNCT_NOR", false,-1, 5,0);
    tracep->declBus(c+226,"FUNCT_SLT", false,-1, 5,0);
    tracep->declBus(c+214,"FUNCT_JR", false,-1, 5,0);
    tracep->declBus(c+203,"ALU_OP_AND", false,-1, 3,0);
    tracep->declBus(c+204,"ALU_OP_OR", false,-1, 3,0);
    tracep->declBus(c+205,"ALU_OP_ADD", false,-1, 3,0);
    tracep->declBus(c+206,"ALU_OP_SUB", false,-1, 3,0);
    tracep->declBus(c+207,"ALU_OP_NOR", false,-1, 3,0);
    tracep->declBus(c+208,"ALU_OP_SLT", false,-1, 3,0);
    tracep->declBus(c+227,"ALU_OP_NOP", false,-1, 3,0);
    tracep->declBus(c+198,"J_TYPE_NOP", false,-1, 2,0);
    tracep->declBus(c+199,"J_TYPE_BEQ", false,-1, 2,0);
    tracep->declBus(c+200,"J_TYPE_JAL", false,-1, 2,0);
    tracep->declBus(c+201,"J_TYPE_JR", false,-1, 2,0);
    ...
    tracep->declBit(c+54,"idex_flush", false,-1);
    tracep->declBit(c+55,"exmem_flush", false,-1);
    tracep->declBus(c+70,"hazard_type", false,-1, 1,0);
    tracep->declBit(c+51,"ifid_gate", false,-1);
    tracep->declBit(c+52,"pc_gate", false,-1);
    tracep->declBit(c+53,"ifid_reset", false,-1);
    tracep->declBit(c+55,"exmem_reset", false,-1);
    tracep->declBit(c+54,"idex_reset", false,-1);
    tracep->declBus(c+71,"data_stall_counter", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+37,"EX_we_dmem", false,-1);
    tracep->declBus(c+29,"EX_pc", false,-1, 31,0);
    tracep->declBus(c+72,"EX_jump_addr", false,-1, 25,0);
    tracep->declBus(c+31,"EX_op", false,-1, 3,0);
    tracep->declBus(c+32,"EX_imm", false,-1, 31,0);
    tracep->declBus(c+33,"EX_ra", false,-1, 31,0);
    tracep->declBus(c+23,"EX_rs1", false,-1, 31,0);
    ...
    tracep->declBus(c+38,"EX_wbsel", false,-1, 1,0);
    tracep->declBit(c+39,"EX_ssel", false,-1);
    tracep->declBus(c+73,"EX_jump_type", false,-1, 2,0);
    tracep->popNamePrefix(1);
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+74+i*1,"R", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vhw3_tb___024root__trace_init_sub__TOP__hw3_tb__core_top_inst__imem_inst__0(Vhw3_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declBus(c+108,"addr", false,-1, 5,0);
    tracep->declBus(c+162,"rdata", false,-1, 31,0);
    for (int i = 0; i < 16; ++i) {
...
VL_ATTR_COLD void Vhw3_tb___024root__trace_full_sub_0(Vhw3_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+69,((2U == (vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__instr 
                                     >> 0x1aU))));
    tracep->fullCData(oldp+70,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__hazard_ctrl_inst__DOT__hazard_type),2);
    tracep->fullIData(oldp+71,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__hazard_ctrl_inst__DOT__data_stall_counter),32);
    tracep->fullIData(oldp+72,(vlSymsp->TOP__hw3_tb__core_top_inst.__Vcellout__idex_instr__EX_jump_addr),26);
    tracep->fullCData(oldp+73,(vlSymsp->TOP__hw3_tb__core_top_inst.__Vcellout__idex_instr__EX_jump_type),3);
    tracep->fullIData(oldp+74,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[0]),32);
    tracep->fullIData(oldp+75,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[1]),32);
    tracep->fullIData(oldp+76,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[2]),32);
    tracep->fullIData(oldp+77,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[3]),32);
    tracep->fullIData(oldp+78,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[4]),32);
    tracep->fullIData(oldp+79,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[5]),32);
    tracep->fullIData(oldp+80,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[6]),32);
    tracep->fullIData(oldp+81,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[7]),32);
    tracep->fullIData(oldp+82,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[8]),32);
    tracep->fullIData(oldp+83,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[9]),32);
    tracep->fullIData(oldp+84,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[10]),32);
    tracep->fullIData(oldp+85,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[11]),32);
    tracep->fullIData(oldp+86,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[12]),32);
    tracep->fullIData(oldp+87,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[13]),32);
    tracep->fullIData(oldp+88,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[14]),32);
    tracep->fullIData(oldp+89,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[15]),32);
    tracep->fullIData(oldp+90,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[16]),32);
    tracep->fullIData(oldp+91,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[17]),32);
    tracep->fullIData(oldp+92,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[18]),32);
    tracep->fullIData(oldp+93,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[19]),32);
    tracep->fullIData(oldp+94,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[20]),32);
    tracep->fullIData(oldp+95,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[21]),32);
    tracep->fullIData(oldp+96,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[22]),32);
    tracep->fullIData(oldp+97,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[23]),32);
    tracep->fullIData(oldp+98,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[24]),32);
    tracep->fullIData(oldp+99,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R[25]),32);
    tracep->fullIData(oldp+100,(vlSymsp->TOP__hw3_tb__core_top_inst.__PVT__reg_file_inst__DOT__R
    tracep->fullIData(oldp+140,(vlSymsp->TOP__hw3_tb.golden_reg[28]),32);
    tracep->fullIData(oldp+141,(vlSymsp->TOP__hw3_tb.golden_reg[29]),32);
    tracep->fullIData(oldp+142,(vlSymsp->TOP__hw3_tb.golden_reg[30]),32);
    tracep->fullIData(oldp+143,(vlSymsp->TOP__hw3_tb.golden_reg[31]),32);
    tracep->fullIData(oldp+144,(vlSymsp->TOP__hw3_tb.golden_dmem[0]),32);
    tracep->fullIData(oldp+145,(vlSymsp->TOP__hw3_tb.golden_dmem[1]),32);
    tracep->fullIData(oldp+146,(vlSymsp->TOP__hw3_tb.golden_dmem[2]),32);
    tracep->fullIData(oldp+147,(vlSymsp->TOP__hw3_tb.golden_dmem[3]),32);
    tracep->fullIData(oldp+148,(vlSymsp->TOP__hw3_tb.golden_dmem[4]),32);
    tracep->fullIData(oldp+149,(vlSymsp->TOP__hw3_tb.golden_dmem[5]),32);
    tracep->fullIData(oldp+150,(vlSymsp->TOP__hw3_tb.golden_dmem[6]),32);
    tracep->fullIData(oldp+151,(vlSymsp->TOP__hw3_tb.golden_dmem[7]),32);
    tracep->fullIData(oldp+152,(vlSymsp->TOP__hw3_tb.golden_dmem[8]),32);
    tracep->fullIData(oldp+153,(vlSymsp->TOP__hw3_tb.golden_dmem[9]),32);
    tracep->fullIData(oldp+154,(vlSymsp->TOP__hw3_tb.golden_dmem[10]),32);
    tracep->fullIData(oldp+155,(vlSymsp->TOP__hw3_tb.golden_dmem[11]),32);
    tracep->fullIData(oldp+156,(vlSymsp->TOP__hw3_tb.golden_dmem[12]),32);
    tracep->fullIData(oldp+157,(vlSymsp->TOP__hw3_tb.golden_dmem[13]),32);
    tracep->fullIData(oldp+158,(vlSymsp->TOP__hw3_tb.golden_dmem[14]),32);
    tracep->fullIData(oldp+159,(vlSymsp->TOP__hw3_tb.golden_dmem[15]),32);
    ...
    tracep->fullIData(oldp+196,(0x10U),32);
    tracep->fullIData(oldp+197,(vlSymsp->TOP__hw3_tb.__PVT__tmp),32);
    ...
    tracep->fullCData(oldp+203,(0U),4);
    tracep->fullCData(oldp+204,(1U),4);
    tracep->fullCData(oldp+205,(2U),4);
    tracep->fullCData(oldp+206,(6U),4);
    tracep->fullCData(oldp+207,(0xcU),4);
    tracep->fullCData(oldp+208,(7U),4);
    tracep->fullCData(oldp+209,(9U),4);
    tracep->fullCData(oldp+210,(0xaU),4);
    tracep->fullCData(oldp+211,(0xdU),4);
    tracep->fullCData(oldp+212,(0xeU),4);
    tracep->fullCData(oldp+213,(0U),6);
    tracep->fullCData(oldp+214,(8U),6);
    tracep->fullCData(oldp+215,(0xaU),6);
    tracep->fullCData(oldp+216,(0x23U),6);
    tracep->fullCData(oldp+217,(0x2bU),6);
    tracep->fullCData(oldp+218,(4U),6);
    tracep->fullCData(oldp+219,(3U),6);
    tracep->fullCData(oldp+220,(2U),6);
    tracep->fullCData(oldp+221,(0x20U),6);
    tracep->fullCData(oldp+222,(0x22U),6);
    tracep->fullCData(oldp+223,(0x24U),6);
    tracep->fullCData(oldp+224,(0x25U),6);
    tracep->fullCData(oldp+225,(0x27U),6);
    tracep->fullCData(oldp+226,(0x2aU),6);
    tracep->fullCData(oldp+227,(0xfU),4);
}
