...
VL_ATTR_COLD void Vhw3_tb_imem___initial__TOP__hw3_tb__core_top_inst__imem_inst__1(Vhw3_tb_imem* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vhw3_tb_imem___initial__TOP__hw3_tb__core_top_inst__imem_inst__1\n"); );
    // Body
    vlSelf->RAM[0U] = 0U;
    vlSelf->RAM[1U] = 0U;
    vlSelf->RAM[2U] = 0U;
...
VL_ATTR_COLD void Vhw3_tb_imem___ctor_var_reset(Vhw3_tb_imem* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vhw3_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vhw3_tb_imem___ctor_var_reset\n"); );
    // Body
